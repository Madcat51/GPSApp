...
import site.madcat.gpsapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val locationListener = object : LocationListener {
        ...
        override fun onProviderEnabled(provider: String) {//логирование
    ...
    private fun initClickListeners() {
        ...
        binding.lastKnownLocationButton.setOnClickListener {
            if (checkSelfPermission(GPS_PERMISSION) != PackageManager.PERMISSION_GRANTED) return@setOnClickListener
